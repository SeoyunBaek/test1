...
public class ReviewProc implements ReviewProcInter{
  ...
  public ArrayList<ReviewVO> list_by_review_search(HashMap map) {
    ...
    for (int i=0; i < count; i++) {
      ...
      String thumb = getThumb(reviewVO); // 대표 이미지 추출 
...
//    str.append("현재 페이지: " + nowPage + " / " + totalPage + "  "); 
    ...
    if (nowGrp >= 2){ 
      str.append("<span class='span_box_1'><A href='./"+listFile+"?&word="+word+"&nowPage="+_nowPage+"&goodsno="+goodsno+"'>이전</A></span>"); 
    } 
    ...
    if (nowGrp < totalGrp){ 
      str.append("<span class='span_box_1'><A href='./"+listFile+"?&word="+word+"&nowPage="+_nowPage+"&goodsno="+goodsno+"'>다음</A></span>"); 
    } 
    str.append("</DIV>"); 
