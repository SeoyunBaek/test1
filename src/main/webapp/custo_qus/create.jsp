...
<DIV class='title_line'>문의사항 작성</DIV>
...
<%--   <ASIDE style='float: left;'>
 ...
 <input type='hidden' name='custoqusno' id='custoqusno' value='1'>
 
        <div class="form-group">
          <label for="title" class="col-md-1 control-label">글 제목</label>
          <div class="col-md-11">
            <input type='text' class="form-control input-lg" name='title' id='title' value='문의 사항' required="required" style='width: 80%;'>
          </div>
        </div>
        <div class="form-group">   
        <label for="askcont" class="col-md-1 control-label">내용</label>
        <div class="col-md-11">
          <textarea class="form-control input-lg" name='askcont' id='askcont'  rows='10'>주소를 바꿔주세요.</textarea>
        </div>
      </div>
      ...
      <DIV style='text-align: right;'>
        ...
        <button type='button' onclick="location.href='../custo_qus/list_by_custo_search_paging.do?memno=${memVO.memno }&custoqusno=${custoVO.custoqusno }&word=${word}&nowPage=${nowPage}'" class="btn btn-primary btn-md">취소[목록]</button>
