...
<DIV class='content' style='width: 90%;'>   
  ...
  <form name='frm' id='frm' method="get" action="./list_by_review_search_paging.do">
...
<%--     <A href='../categrp/list.do'>카테고리 그룹</A> >
  ...
  <ASIDE style='float: right;'>
    ...
    <A href='./create.do?goodsno=1'>등록</A>    
    ...
    <button type='button' 
                 onclick="location.href='./list_by_review_search_paging.do?goodsno=${goods_ReviewVO.goodsno }'">전체 보기</button>
...
<%--                <c:when test="${reviewVO.ansnum>0 }"> <!-- 답변글인 경우 -->
                <img src='./images/white.png' style='width: ${custoVO.indent * 20}px; opacity: 0.0;'>
                <img src='./images/reply3.png'>   
                <a href="../ctsans/read.do?custoqusno=${custoVO.custoqusno}&answerno=${ctsansVO.answerno}&word=${param.word}&nowPage=${param.nowPage}">${ctsansVO.answer}</a>
               </c:when> --%>
             </c:choose>
            <a href="./read.do?goodsno=${reviewVO.goodsno}&reviewno=${reviewVO.reviewno}&word=${param.word}&nowPage=${param.nowPage}">${reviewVO.writing}</a>
            <%-- <a href="../ctsans/list_all_ctsans.do?custoqusno=${ctsansVO.custoqusno}&answerno=${ctsansVO.answerno}&word=${param.word}&nowPage=${param.nowPage}">${ctsansVO.answer}</a> --%>
            </td>
            ...
            <td style='text-align: center; vertical-align: middle;'>
              <a href="./update.do?goodsno=${reviewVO.goodsno }&reviewno=${reviewVO.reviewno}"><img src="./images/update.png" title="수정" border='0'/></a>
              <a href="./delete.do?goodsno=${reviewVO.goodsno }&reviewno=${reviewVO.reviewno}"><img src="./images/delete.png" title="삭제"  border='0'/></a>
