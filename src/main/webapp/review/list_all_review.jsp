...
<DIV class='content' style='width: 90%;'>     
  ...
  <ASIDE style='float: right;'>
    ...
    <A href='./create.do?goodsno=1'>등록</A>
        <%-- <input type='hidden' name='goodsno' id='goodsno' value='${custo_CtsansVO.memno }'> --%>
<%--     <span class='menu_divide' >│</span> 
    <c:choose>
      ...
      <tbody>
        <c:forEach var="reviewVO" items="${list }">
          <tr> 
            ...
            <td>
              <a href="./read.do?reviewno=${reviewVO.reviewno}">${reviewVO.writing}</a> 
            </td> 
            <td style='text-align: center;'>${reviewVO.goodsno}</td>
             ...
             <!-- &word=${param.word}&nowPage=${param.nowPage} -->
