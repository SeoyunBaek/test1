...
<%--     <c:if test="${custoVO.files.length() > 0 }">
    ...
    <span class='menu_divide' >│</span> 
    <A href='./list_by_review_search_paging.do?goodsno=${param.goodsno}'>목록</A>
    <span class='menu_divide' >│</span> 
    <A href='./update.do?goodsno=${reviewVO.goodsno }&reviewno=${reviewVO.reviewno }'>수정</A>
    <!-- &nowPage=${param.nowPage } -->
    <span class='menu_divide' >│</span> 
    <A href='./delete.do?goodsno=${reviewVO.goodsno }&reviewno=${reviewVO.reviewno }'>삭제</A>
    <!-- &custoqusno=${custoVO.custoqusno }&word=${word}&nowPage=${nowPage} -->
    
 <%--      <!-- ne => 같지 않을 경우 -->
    <span class='menu_divide' >│</span> 
    <A href='../ctsans/reply.do?custoqusno=1&answerno=1'>답변</A>
    <span class='menu_divide' >│</span> 
    <A href='./update.do?memno=${custoVO.memno }&custoqusno=${custoVO.custoqusno }&nowPage=${param.nowPage }'>수정</A>
    <span class='menu_divide' >│</span> 
    <A href='./delete.do?memno=${custoVO.memno }&custoqusno=${custoVO.custoqusno }&nowPage=${param.nowPage }'>삭제</A>
 --%><%--   <c:if test="${sessionScope.id ne null}"></c:if> --%>
  ...
  <DIV id='main_panel'></DIV>  <!-- 이미지 출력 -->
    ...
    <FORM name='frm' method="get" action='./update.do'>
      ...
      <input type='hidden' name='goodsno' id='goodsno' value='${reviewVO.goodsno }'>
      <fieldset class="fieldset">
        <ul>
          <li class="li_none">
            <span>${reviewVO.writing}</span>
