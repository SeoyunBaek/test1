...
/*    window.onload=function(){
    CKEDITOR.replace('writing');  // <TEXTAREA>태그 id 값
  }; */
...
<!--        <div class="form-group">   
       ...
       <div class="form-group">   
        ...
        <div class="col-md-11">
          <input type='text' class="form-control input-lg" name='word' id='word' value='${reviewVO.word }' placeholder="검색어">
        </div>
      </div>
      ...
      <DIV style='text-align: right;'>
        ...
        <button type="button" onclick="location.href='./list_all_review.do?goodsno=${reviewVO.goodsno}'" class="btn btn-primary btn-md">취소[목록]</button>
      </DIV>
  </FORM>
