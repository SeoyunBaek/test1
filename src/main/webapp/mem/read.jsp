    ...
    <div class="form-group">
      ...
      <div class="col-md-10">
        <input type='text' class="form-control input-md" name='name' id='name' 
                   value='${memVO.name }' required="required" style='width: 30%;' placeholder="성명">
      </div>
    </div>   
    ...
    <div class="form-group">
      ...
      <div class="col-md-10">
        <input type='text' class="form-control input-md" name='phone' id='phone' 
                   value='${memVO.phone }' required="required" style='width: 30%;' placeholder="전화번호"> 예) 010-0000-0000
      </div>
    </div>   
    ...
    <div class="form-group">
      ...
      <div class="col-md-10">
        <input type='text' class="form-control input-md" name='email' id='email' 
                   value='${memVO.email }' style='width: 60%;' placeholder="이메일">
      </div>
    </div>   
    ...
    <div class="form-group">
      ...
      <div class="col-md-10">
        <input type='text' class="form-control input-md" name='zipcode' id='zipcode' 
                   value='${memVO.zipcode }' style='width: 30%;' placeholder="우편번호">
    ...
    <div class="form-group">
      ...
      <div class="col-md-10">
        <input type='text' class="form-control input-md" name='address1' id='address1' 
                   value='${memVO.address1 }' style='width: 80%;' placeholder="주소">
      </div>
    </div>   
    ...
    <div class="form-group">
      ...
      <div class="col-md-10">
        <input type='text' class="form-control input-md" name='address2' id='address2' 
                   value='${memVO.address2 }' style='width: 80%;' placeholder="상세 주소">
      </div>
    </div>   
