...
<DIV class='title_line'>채용공고 작성</DIV>
...
<%--   <ASIDE style='float: left;'>
 ...
 <!-- <input type='hidden' name='employno' id='employno' value='1'> -->
 <input type='hidden' name='diecateno' id='diecateno' value='${param.diecateno }'>
        ...
        <div class="form-group">
          ...
          <div class="col-md-11">
            <input type='text' class="form-control input-lg" name='title' id='title' value='채용 공고' required="required" style='width: 80%;'>
          </div>
        </div>
        <div class="form-group">   
        <label for="contents" class="col-md-1 control-label">내용</label>
        <div class="col-md-11">
          <textarea class="form-control input-lg" name='contents' id='contents'  rows='10'>직원을 모집합니다.</textarea>
        </div>
      </div>
      ...
      <DIV style='text-align: right;'>
        ...
        <button type='button' onclick="location.href='./list_all_employ.do?diecateno=${employVO.diecateno}'" class="btn btn-primary btn-md">취소[목록]</button>
