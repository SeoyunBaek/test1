...
<%--   <ASIDE style='float: left;'>
  ...
  <ASIDE style='float: right;'>
    ...
    <A href='./create.do?diecateno=1'>등록</A>
...
<input type='hidden' name='employno' id='employno' value='${employVO.employno }'>
 <input type='hidden' name='diecateno' id='diecateno' value='1'> <%-- ${diecategrp_cateVO.diecateno } --%>
 <%-- <input type='hidden' name='nowPage' id='nowPage' value='${param.nowPage }'> --%>
   
      <div class="form-group">   
        <label for="title" class="col-md-1 control-label">글 제목</label>
        <div class="col-md-11">
          <input type='text' class="form-control input-md" name='title' id='title' value='${employVO.title}' required="required" style='width: 80%;'>
        </div>
      </div>   
      <div class="form-group">   
        <label for="contents" class="col-md-1 control-label">내용</label>
        <div class="col-md-11">
          <textarea class="form-control input-md" name='contents' id='contents'  rows='10'>${employVO.contents}</textarea>
        </div>
      </div>
...
<%--       <div class="form-group">   
        ...
        <div class="col-md-11">
          <input type='text' class="form-control input-lg" name='id' id='id' value='${employVO.id }' required="required">
        </div>
      </div> --%>
      ...
      <DIV style='text-align: right;'>
        ...
        <button type='button' onclick="location.href='./list_all_employ.do?diecateno=${employVO.diecateno }&employno=${employVO.employno }'" class="btn btn-primary btn-md">취소[목록]</button>
      </DIV>
  </FORM>
