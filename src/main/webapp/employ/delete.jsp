...
<%--   <ASIDE style='float: left;'>
  ...
  <ASIDE style='float: right;'>
    ...
    <span class='menu_divide' >│</span> 
    <A href='./list_all_event.do?diecateno=${param.diecateno}'>전체보기</A>
  </ASIDE> 
  
  <div class='menu_line'></div>
  <FORM name='frm' method='POST' action='./delete.do' enctype="multipart/form-data" class="form-horizontal">
 ...
 <%-- <input type='hidden' name='nowPage' id='nowPage' value='${param.nowPage }'> --%>
      ...
      <div class="form-group">   
        <div class="col-md-12" style='text-align: center; margin: 30px;'>
          삭제 되는글: ${employVO.title }<br><br>
          삭제하시겠습니까? 삭제하시면 복구 할 수 없습니다.<br>
          <br>
          <button type = "submit" class="btn btn-primary btn-md">삭제 진행</button>
