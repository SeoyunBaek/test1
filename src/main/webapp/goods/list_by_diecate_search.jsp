...
<DIV class='content' style='width: 90%;'>     
  ...
  <form name='frm' id='frm' method="get" action="./list_by_diecate_search.do">
  ...
  <ASIDE style='float: right;'>
    ...
    <button type='button' 
                 onclick="location.href='./list_by_diecate_search.do?diecateno=${diecateVO.diecateno }'">전체글</button>
  </ASIDE>
  </form>
      ...
      <tbody>
        <c:forEach var="goodsVO" items="${list }">
          <tr> 
            ...
            <td style='vertical-align: middle;'>
              <a href="./read.do?goodsno=${goodsVO.goodsno}&diecateno=${goodsVO.diecateno}&word=${param.word}">${goodsVO.title}</a> 
            </td> 
 
            <td style='vertical-align: middle;'>${goodsVO.rdate.substring(0, 10)}</td>
            <td style='vertical-align: middle;'>${goodsVO.visit}</td>
