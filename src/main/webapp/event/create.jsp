...
<DIV class='title_line'>이벤트사항 작성</DIV>
...
<%--   <ASIDE style='float: left;'>
 ...
 <input type='hidden' name='diecateno' id='diecateno' value='1'>
        ...
        <div class="form-group">
          ...
          <div class="col-md-11">
            <input type='text' class="form-control input-lg" name='title' id='title' value='이벤트 사항' required="required" style='width: 80%;'>
          </div>
        </div>
        <div class="form-group">   
        <label for="contents" class="col-md-1 control-label">내용</label>
        <div class="col-md-11">
          <textarea class="form-control input-lg" name='contents' id='contents'  rows='10'>귀걸이1 할인 시작</textarea>
        </div>
      </div>

      <div class="form-group">   
        <label for="visible" class="col-md-1 control-label">공개여부</label>
        <div class="col-md-11">
          <input type='text' class="form-control input-lg" name='visible' id='visible' value='Y' required="required">
        </div>
      </div>
      
      <div class="form-group">   
        <label for="id" class="col-md-1 control-label">접근계정</label>
        <div class="col-md-11">
          <input type='text' class="form-control input-lg" name='id' id='id' value='master1' required="required">
        </div>
      </div>
      ...
      <div class="form-group">   
        ...
        <div class="col-md-11">
          <input type='text' class="form-control input-lg" name='word' id='word' value='이벤트,할인'>
        </div>
      </div>
      ...
      <DIV style='text-align: right;'>
        ...
        <button type='button' onclick="location.href='./list_by_event_search_paging.do?diecateno=${eventVO.diecateno }&eventno=${eventVO.eventno }&word=${word}&nowPage=${nowPage}'" class="btn btn-primary btn-md">취소[목록]</button>
