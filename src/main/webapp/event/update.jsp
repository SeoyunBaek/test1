...
<%-- diecateno=${diecateVO.diecateno }&custoqusno=${custoVO.custoqusno } --%>
 ...
 <%-- <input type='hidden' name='nowPage' id='nowPage' value='${param.nowPage }'> --%>
      ...
      <div class="form-group">   
        ...
        <div class="col-md-11">
          <input type='text' class="form-control input-md" name='title' id='title' value='${eventVO.title}' required="required" style='width: 80%;'>
        </div>
      </div>   
      <div class="form-group">   
        <label for="contents" class="col-md-1 control-label">내용</label>
        <div class="col-md-11">
          <textarea class="form-control input-md" name='contents' id='contents'  rows='10'>${eventVO.contents}</textarea>
        </div>
      </div>
      
       <div class="form-group">   
        <label for="word" class="col-md-1 control-label"><span style='font-size: 0.99em;'>검색어</span></label>
        <div class="col-md-11">
          <input type='text' class="form-control input-lg" name='word' id='word' value='${eventVO.word }' placeholder="검색어">
        </div>
      </div>
      ...
      <DIV style='text-align: right;'>
        ...
        <button type='button' onclick="location.href='./list_all_event.do?diecateno=${eventVO.diecateno }&eventno=${eventVO.eventno }'" class="btn btn-primary btn-md">취소[목록]</button>
      </DIV>
  </FORM>
